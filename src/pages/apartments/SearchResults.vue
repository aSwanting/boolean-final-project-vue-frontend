<template>
    <DefaultLayout>
        <div v-if="store.queryData" class="search-component p-5 m-5 border rounded shadow">
    ...
    methods: {
        fetchResults() {
            axios.get("http://127.0.0.1:8000/api/apartments/results/").then((res) => {
                ...
                this.apartments = res.data.results[0].apartments;
                this.query = res.data.results[0].query
